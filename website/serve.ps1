...
# WharfKit loads as an ES module and the app talks to WAX over CORS, so this has
# to be served over http:// - opening index.html from the filesystem fails on
# both counts.
$serverPath = Split-Path -Parent $MyInvocation.MyCommand.Path
$httpListener = New-Object System.Net.HttpListener
$httpListener.Prefixes.Add("http://127.0.0.1:$port/")
$httpListener.Start()
Write-Host "Very Serious Space War - map viewer"
